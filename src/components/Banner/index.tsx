  ...
  return (
    <>
      ...
      <section
        ...
        id="static-content"
      >
        <div className="sticky top-20 max-w-[800px] text-center mx-auto grid gap-18 text-white">
          <div>
            <h1 className="font-extrabold mb-3 text-5xl lcp-title whitespace-nowrap">
              Bernal Baltodano
            </h1>
          ...
          <div className="flex items-center justify-center gap-8">
            <a
              href="https://github.com/balt-script"
            ...
            <a
              href="https://www.linkedin.com/in/bernal-baltodano-dev/"
      ...
      >
        <section ref={homeBannerRef} className="container h-[900px] relative">
          <div className="sticky top-20 max-w-[800px] text-center mx-auto grid gap-18">
            <motion.div
              style={{
                color: textStyles.color,
              }}
            >
              <h1 className="font-extrabold mb-3 text-5xl whitespace-nowrap">Bernal Baltodano</h1>
