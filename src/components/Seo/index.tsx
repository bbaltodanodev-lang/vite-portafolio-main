...
export default function Seo({
  title = "Bernal Baltodano - DevOps Engineer & Full Stack Developer",
  ...
  const seo: Seo = {
    title,
    description,
    titleTemplate: "%s | Bernal Baltodano - DevOps & Full Stack",
  ...
  const personSchema = {
    ...
    "@type": "Person",
    name: "Bernal Baltodano",
    jobTitle: "DevOps Engineer & Full Stack Developer",
    url: url,
    sameAs: [
      "https://github.com/balt-script",
      "https://www.linkedin.com/in/bernal-baltodano-dev/",
    ],
    knowsAbout: [
      "DevOps",
      "AWS",
  ...
  const websiteSchema = {
    "@context": "https://schema.org",
    "@type": "WebSite",
    name: "Bernal Baltodano - Portafolio",
    url: url,
    description: description,
    author: {
      "@type": "Person",
  ...
  return (
    <Helmet title={seo.title} titleTemplate={seo.titleTemplate}>
      ...
      <meta name="author" content="Bernal Baltodano" />
  ...
  return (
    <>
      ...
      <meta
        ...
        content="Bernal Baltodano - DevOps & Full Stack Developer"
      />
      ...
      <meta
        ...
        content="Bernal Baltodano - DevOps Engineer & Full Stack Developer"
      />
  ...
  return (
    <>
      ...
      <meta
        ...
        content="https://www.linkedin.com/in/bernal-baltodano-dev/"
      />
      á
      <meta name="author" content="Bernal Baltodano" />
    </>
